...
public class MailService {
	...
	public void sendCreationmail(Booking booking){
		...
		StringBuilder mailBody = new StringBuilder("<html><img src=\"https://bep2-ruben.herokuapp.com/mailbanner.png\"<br>");
		...
		String url=String.format("https://bep2-ruben.herokuapp.com/booking/confirm/%s", booking.getId());
	...
	public void sendConfirmationmail(Booking booking){
		...
		String mailBody = "<html><img src=\"https://bep2-ruben.herokuapp.com/mailbanner.png\"<br>" + String.format("<h3>Booking with destination %s has been confirmed.</h3>" + "Departure: %s at %s <br> Arrival: %s at %s <br>", flight.getRoute().getDestination().getName(),
